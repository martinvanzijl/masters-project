...
APP_RESPONSE_TIME_MIN=500
APP_RESPONSE_TIME_MAX=1000
APP_RESPONSE_TIME_INC=500
...
TOTAL_TEST_CASES=$(( ((CPU_SCALE_THRESHOLD_MAX-CPU_SCALE_THRESHOLD_MIN)/CPU_SCALE_THRESHOLD_INC + 1) * ((MAX_RPS_MAX-MAX_RPS_MIN)/MAX_RPS_INC + 1) * ((MAX_REPLICAS_MAX-MAX_REPLICAS_MIN)/MAX_REPLICAS_INC + 1) * ((APP_RESPONSE_TIME_MAX-APP_RESPONSE_TIME_MIN)/APP_RESPONSE_TIME_INC + 1) ))
#* ((MIN_REPLICAS_MAX-MIN_REPLICAS_MIN)/MIN_REPLICAS_INC + 1)
