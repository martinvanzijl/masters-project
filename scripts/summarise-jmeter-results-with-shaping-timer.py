...
csv_writer.writerow(["RPS (low)", "RPS (high)", "Duration (low)", "Duration (high)", "App. Processing Time", "Min Pods", "Max Pods", "Initial Pods", "Scale CPU", "Value 1", "Value 2", "Value 3", "Proportion", "Meets"])
